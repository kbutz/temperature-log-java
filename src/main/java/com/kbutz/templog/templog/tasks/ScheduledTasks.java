...
import com.kbutz.templog.templog.data.BasementTemp;
...
public class ScheduledTasks {
    ...
    public void reportCurrentTime() {
        ...
        BasementTemp b = null;
        try {
            b = objectMapper.readValue(tempRead, BasementTemp.class);
        } catch (IOException e) {
            e.printStackTrace();
        }

//        log.info(b.getBasementTemp());
        temperatureRepository.save(new TemperatureReading(b.getBasementTemp(), new Date()));
